...
#SBATCH --output=/home/zw529/donglab/data/target_ALS/QTL/run_eQTL_combined_%j.out
#SBATCH --error=/home/zw529/donglab/data/target_ALS/QTL/run_eQTL_combined_%j.err
...
# ── Step 0: Pre-flight ────────────────────────────────────────────────
echo "[0] Verifying file existence..."
