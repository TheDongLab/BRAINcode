...
# ----------------------------
# Exons merged per gene (fixed)
# ----------------------------
sort -k1,1V -k2,2n -k6,6 "${STAR_DIR}/exons.unmerged.bed" \
    | bedtools merge -i - -c 4 -o collapse -s \
...
# ----------------------------
# Introns merged per gene (fixed)
# ----------------------------
sort -k1,1V -k2,2n -k6,6 "${STAR_DIR}/introns.unmerged.bed" \
    | bedtools merge -i - -c 4 -o collapse -s \
