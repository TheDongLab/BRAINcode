...
print("\n======================================================================\nsQTL SMR + SMR-MULTI + HEIDI SUMMARY\n======================================================================")
...
if len(single_hits):
    cols=["tissue","probeID","Gene","topSNP","p_sQTL","p_GWAS","p_SMR","FDR_SMR_tissue","FDR_SMR_global","p_HEIDI","nsnp_HEIDI","HEIDI_pass"]
...
if len(multi_hits):
    cols=["tissue","probeID","Gene","topSNP","p_sQTL","p_GWAS","p_SMR_multi","FDR_SMR_multi_tissue","FDR_SMR_multi_global","p_HEIDI","nsnp_HEIDI","HEIDI_pass"]
